...
#filepath = "/home/tlg/Document/Sources/rosprj" #os.path.abspath('..')+"/bin"
...
timestamp = []
tx_index = 0
position = np.loadtxt('/home/tlg/Document/Sources/rosprj/imupose.txt', usecols = (tx_index, tx_index + 1, tx_index + 2))

# imu_pose   imu_spline
position1 = []
quaterntions1 = []
timestamp1 = []
data = np.loadtxt('/home/tlg/Document/Sources/rosprj/imupose.txt')
# timestamp1 = data[:,0]
